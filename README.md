...
- **Permalinks + page:** a `setSiteOptions` step switches permalinks to `/%postname%/`, and a `runPHP` step builds the Beats Playground page (with all of the shortcodes shown above) and sets it as the homepage before flushing rewrite rules.
